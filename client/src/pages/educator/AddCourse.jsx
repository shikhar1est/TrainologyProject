    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
           <p>Course Title</p>
           <input onChange={e=>setCourseTitle(e.target.value)} value={courseTitle} placeholder='Type Here' type="text" 
        ...
        <div className='flex items-center justify-between flex-wrap'>
         ...
         <div className='flex flex-col gap-1'>
              <p>Discount %</p>
              <input type="number" placeholder='0' min={0} max={100} onChange={e=>setDiscount(e.target.value)}
               value={discount} className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' required/>
         </div>
         <div>
          {
              ...
              <div key={chapterIndex} className='bg-white rounded-lg border mb-4'>
                 <div className='flex justify-between items-center p-4 border-b'>
                    <div className='flex items-center'>
                        <img onClick={()=>handleChapter('toggle',chapter.chapterId)} src={assets.dropdown_icon} width={14} alt="Dropdown" className=
                 ...
                 {!chapter.collapsed && (
                  <div className='p-4'>
                      ...
                      <div className='inline-flex bg-gray-100 p-2 rounded cursor-pointer m-2' 
